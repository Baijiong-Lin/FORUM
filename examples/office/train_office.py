...
def main(params):
    ...
    # prepare dataloaders
    data_loader, _ = office_dataloader(dataset=params.dataset, batchsize=int(params.bs/2), root_path=params.dataset_path)
    ...
    if params.method == 'FORUM':
        officeModel.train_FORUM(train_dataloaders=train_dataloaders, 
        ...
        officeModel.train_MOML(train_dataloaders=train_dataloaders, 
                          val_dataloaders=val_dataloaders,
                          test_dataloaders=test_dataloaders, 
                          epochs=params.epochs,
                          eta=params.eta)
