...
def main(params):
    ...
    nyuv2_train_loader = torch.utils.data.DataLoader(
        ...
        batch_size=int(params.train_bs/2),
        shuffle=True,
        num_workers=2,
        pin_memory=True,
        drop_last=True)
    ...
    if params.method == 'FORUM':
        NYUmodel.train_FORUM(nyuv2_train_loader, nyuv2_test_loader, params.epochs,
                            rho=params.rho,
                            eta=params.eta,
                            inner_step=params.inner_step)
    elif params.method == 'MOML':
        NYUmodel.train_MOML(nyuv2_train_loader, nyuv2_test_loader, params.epochs, eta=params.eta)
    else:
        raise ValueError
