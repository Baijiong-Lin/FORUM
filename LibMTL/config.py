...
_parser.add_argument('--load_path', type=str, default=None, 
                    help='load ckpt path')
_parser.add_argument('--method', type=str, default='FOMOBO', help='ORG, FOMOBO, MOML, BOME')
## optim
...
## FORUM
_parser.add_argument('--rho', type=float, default=0.1, help=' ') # FORUM
_parser.add_argument('--eta', type=float, default=0.1, help='LL lr') # FORUM, MOML
_parser.add_argument('--inner_step', type=int, default=5, help=' ') # FORUM
